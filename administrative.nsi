...
Section "Autolainaussovellus hallinta" SecProgram
  ...
  # READ FILES RECURSIVELY FROM DISTRIBUTION FOLDER CREATED BY PYINSTALLER
...
# Descriptions
  ...
  LangString DESC_SecProgram ${LANG_ENGLISH} "The program to administer vehicles and users"
