...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(0, 0, 1051, 581))
        font = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.removeVehiclePushButton.setStyleSheet(u"\n"
"background-color: rgb(255, 1, 5);")
...
"color: rgb(255, 255, 255);")
        ...
        self.diaryTableWidget.setRowCount(10000)
        self.diaryTableWidget.setColumnCount(9)
        self.diaryTableWidget.horizontalHeader().setCascadingSectionResizes(False)
...
"color: rgb(255, 255, 255);")
        ...
        self.vehicleTypeFrame = QFrame(self.maintenanceTab)
        self.vehicleTypeFrame.setObjectName(u"vehicleTypeFrame")
        self.vehicleTypeFrame.setGeometry(QRect(10, 30, 341, 451))
        self.vehicleTypeFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.vehicleTypeFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.vehicleTypeTableWidget = QTableWidget(self.vehicleTypeFrame)
        ...
        self.vehicleTypeTableWidget.setGeometry(QRect(10, 100, 261, 192))
        ...
        self.vehicleTypeTableWidget.verticalHeader().setStretchLastSection(True)
        self.vehicleTypeAddLineEdit = QLineEdit(self.vehicleTypeFrame)
        self.vehicleTypeAddLineEdit.setObjectName(u"vehicleTypeAddLineEdit")
        self.vehicleTypeAddLineEdit.setGeometry(QRect(20, 40, 181, 21))
        self.vehicleTypeAddPushButton = QPushButton(self.vehicleTypeFrame)
        self.vehicleTypeAddPushButton.setObjectName(u"vehicleTypeAddPushButton")
        self.vehicleTypeAddPushButton.setGeometry(QRect(220, 40, 75, 24))
...
"color: rgb(255, 255, 255);\n"
"")
        self.vehicleTypeDeletePushButton = QPushButton(self.vehicleTypeFrame)
        self.vehicleTypeDeletePushButton.setObjectName(u"vehicleTypeDeletePushButton")
        self.vehicleTypeDeletePushButton.setGeometry(QRect(220, 310, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.vehicleTypeAddLabel = QLabel(self.vehicleTypeFrame)
        self.vehicleTypeAddLabel.setObjectName(u"vehicleTypeAddLabel")
        self.vehicleTypeAddLabel.setGeometry(QRect(30, 10, 101, 16))
        self.reasonFrame = QFrame(self.maintenanceTab)
        self.reasonFrame.setObjectName(u"reasonFrame")
        self.reasonFrame.setGeometry(QRect(360, 30, 331, 451))
        self.reasonFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.reasonFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.reasonAddTableWidget = QTableWidget(self.reasonFrame)
        ...
        self.reasonAddTableWidget.setGeometry(QRect(10, 90, 251, 192))
        self.reasonAddTableWidget.setSortingEnabled(True)
        self.reasonAddTableWidget.setRowCount(10)
        self.reasonAddTableWidget.setColumnCount(1)
        self.reasonAddTableWidget.horizontalHeader().setStretchLastSection(True)
        self.reasonAddLineEdit = QLineEdit(self.reasonFrame)
        self.reasonAddLineEdit.setObjectName(u"reasonAddLineEdit")
        self.reasonAddLineEdit.setGeometry(QRect(20, 40, 181, 21))
        self.reasonAddPushButton = QPushButton(self.reasonFrame)
        self.reasonAddPushButton.setObjectName(u"reasonAddPushButton")
        self.reasonAddPushButton.setGeometry(QRect(220, 40, 75, 24))
...
"color: rgb(255, 255, 255);\n"
"")
        self.reasonDeletePushButton = QPushButton(self.reasonFrame)
        self.reasonDeletePushButton.setObjectName(u"reasonDeletePushButton")
        self.reasonDeletePushButton.setGeometry(QRect(220, 300, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.reasonAddLabel = QLabel(self.reasonFrame)
        self.reasonAddLabel.setObjectName(u"reasonAddLabel")
        self.reasonAddLabel.setGeometry(QRect(30, 10, 91, 16))
        self.osastoFrame = QFrame(self.maintenanceTab)
        self.osastoFrame.setObjectName(u"osastoFrame")
        self.osastoFrame.setGeometry(QRect(700, 30, 321, 451))
        self.osastoFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.osastoFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.osastoTableWidget = QTableWidget(self.osastoFrame)
        if (self.osastoTableWidget.columnCount() < 1):
            self.osastoTableWidget.setColumnCount(1)
        if (self.osastoTableWidget.rowCount() < 10):
            self.osastoTableWidget.setRowCount(10)
        self.osastoTableWidget.setObjectName(u"osastoTableWidget")
        self.osastoTableWidget.setGeometry(QRect(10, 100, 271, 192))
        self.osastoTableWidget.setSortingEnabled(True)
        self.osastoTableWidget.setRowCount(10)
        self.osastoTableWidget.setColumnCount(1)
        self.osastoTableWidget.horizontalHeader().setStretchLastSection(True)
        self.osastoTableWidget.verticalHeader().setStretchLastSection(True)
        self.osastoAddLineEdit = QLineEdit(self.osastoFrame)
        self.osastoAddLineEdit.setObjectName(u"osastoAddLineEdit")
        self.osastoAddLineEdit.setGeometry(QRect(20, 40, 161, 21))
        self.osastoAddPushButton = QPushButton(self.osastoFrame)
        self.osastoAddPushButton.setObjectName(u"osastoAddPushButton")
        self.osastoAddPushButton.setGeometry(QRect(220, 40, 75, 24))
        self.osastoAddPushButton.setFont(font1)
        self.osastoAddPushButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.osastoAddPushButton.setStyleSheet(u"background-color: rgb(57, 136, 220);\n"
"color: rgb(255, 255, 255);\n"
"")
        self.osastoDeletePushButton = QPushButton(self.osastoFrame)
        self.osastoDeletePushButton.setObjectName(u"osastoDeletePushButton")
        self.osastoDeletePushButton.setGeometry(QRect(240, 310, 75, 24))
        self.osastoDeletePushButton.setFont(font1)
        self.osastoDeletePushButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.osastoDeletePushButton.setStyleSheet(u"background-color: rgb(255, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.osastoAddLabel = QLabel(self.osastoFrame)
        self.osastoAddLabel.setObjectName(u"osastoAddLabel")
        self.osastoAddLabel.setGeometry(QRect(30, 10, 101, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.agbRestrictionCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Ajaminen sallittu vain automaattivaihteilla, pakollinen kentt\u00e4", None))
...
#if QT_CONFIG(tooltip)
        self.vehicleCatalogTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"Valitse auto klikkaamalla solua. T\u00e4m\u00e4n j\u00e4lkeen auton voi poistaa tai est\u00e4\u00e4 sen lainaamisen.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.ssnFilterLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Rajataan ajop\u00e4iv\u00e4kirjan tietoja henkil\u00f6tunnuksen perusteella.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.registerFilterLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Rajataan ajop\u00e4iv\u00e4kirjan tietoja rekisterinumeron perusteella.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.reasonFilterLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Rajataan ajop\u00e4iv\u00e4kirjan tietoja tarkoituksen perusteella.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.vehicleTypeTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Voit poistaa ajoneuvo tyypin valitsemalla sen taulusta ja painamalla Poista-painiketta, jos tyypill\u00e4 on jo ajop\u00e4iv\u00e4kirjamerkint\u00f6j\u00e4 poistaminen ei ole mahdollista.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.reasonAddTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Voit poistaa ajon tarkoituksen valitsemalla sen taulukosta ja painamalla Poista-painiketta, jos tarkoituksella on jo ajop\u00e4iv\u00e4kirjamerkint\u00f6j\u00e4, poistaminen ei ole mahdollista.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.reasonAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Lis\u00e4\u00e4 kentt\u00e4\u00e4n ajon tarkoitus ja paina Lis\u00e4\u00e4- painiketta. Painike tulee n\u00e4kyviin kirjoitettuasi kentt\u00e4\u00e4n.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.osastoTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Voit poistaa ajoneuvo tyypin valitsemalla sen taulusta ja painamalla Poista-painiketta, jos tyypill\u00e4 on jo ajop\u00e4iv\u00e4kirjamerkint\u00f6j\u00e4 poistaminen ei ole mahdollista.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.osastoAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Kirjoita kentt\u00e4\u00e4n lis\u00e4tt\u00e4v\u00e4 ajoneuvotyyppi ja paina Lis\u00e4\u00e4-painiketta. Painike tulee n\u00e4kyviin kirjoitettuasi kentt\u00e4\u00e4n.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.osastoAddPushButton.setText(QCoreApplication.translate("MainWindow", u"Lis\u00e4\u00e4", None))
        self.osastoDeletePushButton.setText(QCoreApplication.translate("MainWindow", u"Poista", None))
        self.osastoAddLabel.setText(QCoreApplication.translate("MainWindow", u"Osasto", None))
